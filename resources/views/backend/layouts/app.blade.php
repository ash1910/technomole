...
<head>
  ...
  <title>TechnoMole Creations Ltd - TMC</title>
  ...
  <!-- Sweet alert -->
  <link href="{{asset('public/backend')}}/plugins/sweetalert2/sweetalert2.min.css" rel="stylesheet" type="text/css" />
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
  <div class="wrapper">
    ...
    <footer class="main-footer">
      <strong>Copyright &copy; {{date('Y')}} Techno Mole Creations Ltd.</strong>
    </footer>
  </div>
  <!-- ./wrapper -->
              ...
              <div id="collapsePostList" class="collapse" role="tabpanel" aria-labelledby="headingPostList" data-parent="#accordion">
                <table class="table table-hover" style="margin-bottom: 0;">
                  <tbody>
                    ...
                    <tr>
                      <td class="linkdata" data-url_type="2" data-id="{{str_slug($menupost->title_en,'-')}}" style="cursor: pointer;background: #584200;color:white;font-weight: bold;">
