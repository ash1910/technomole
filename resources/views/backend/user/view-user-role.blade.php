...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark"> Manage User Role</h1>
      </div>
      <div class="col-sm-6">
      ...
      <div class="col-lg-12">
        <div class="card"> 
          <div class="card-header">
            <a id="demo-btn-addrow" class="btn btn-success btn-sm text-white" data-toggle="modal" data-target="#myModal"><i class="fas fa-plus"></i> Role Add</a>
          </div>
          <div class="card-body">
          ...
          <form id="menuForm" action="{{ route('user.role.store') }}" method="post" >
            ...
            <div class="card-body">
              <div class="col-sm-12">
                ...
                <div class="form-group">
                  <label class="control-label">Role Functionality</label>
