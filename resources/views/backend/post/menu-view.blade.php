              ...
              <div class="col-md-6">
                <div class="dd" id="nestable" style="width: 100%;">
                  ...
                  <ol class="dd-list new_data">
                    ...
                    <li class="dd-item" data-rand_id="{{$parent->rand_id}}" data-title_en="{{$parent->title_en}}" data-title_bn="{{$parent->title_bn}}" data-url_link="{{$parent->url_link}}" data-url_link_type="{{$parent->url_link_type}}" data-url_link_file="" data-status="{{$parent->status}}" data-target="{{$parent->target}}">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        ...
                        <input type="text" name="title_bn" id="title_bn" class="form-control form-control-sm" value="">
...
<script>
  $(document).ready(function(){
    ...
    $(document).on('click','.menu-edit',function(){
      ...
      var title_bn = $(this).parents('.dd-item').attr('data-title_bn');
      ...
      var title_bn = $('#title_bn').val(title_bn);
