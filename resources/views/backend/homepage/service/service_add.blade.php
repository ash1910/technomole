		...
		<div class="card">
			<div class="card-header">
				<h5>
					...
					Add Service
					@endif
					<a class="btn btn-sm btn-success float-right" href="{{route('homepages.service.view')}}"><i class="fa fa-list"></i>Service List</a></h5>
			</div>
			<!-- Form Start-->
			<form method="post" action="{{!empty($editData->id) ? route('homepages.service.update',$editData->id) : route('homepages.service.store')}}" enctype="multipart/form-data" id="myForm">
				@csrf
				<div class="card-body">
